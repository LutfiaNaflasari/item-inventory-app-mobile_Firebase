...
public class Tambah extends AppCompatActivity {
    ...
    // mengatur pada bagian halaman menu Tambah yang didalamnya berisi kegiatan menginputkan data barang
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //melakukan penyimpanan data ketika tombol simpan di klik
        bSimpan.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                //beri info jika data masih kosong
                if(kode.trim().equals("")){
